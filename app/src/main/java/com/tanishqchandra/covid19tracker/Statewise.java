...
public class Statewise extends AppCompatActivity implements StatewiseAdapter.OnItemClickListner {
                    ...
                    if (!testValue.isEmpty()) {
                        Runnable progressRunnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                statewiseAdapter.setOnItemClickListner(Statewise.this);
                            }
                        };
    ...
    public void showProgressDialog() {
        progressDialog = new ProgressDialog(Statewise.this);
        progressDialog.show();
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(Statewise.this, "Internet slow/not available", Toast.LENGTH_SHORT).show();
                }
            }
        };
        Handler pdCanceller = new Handler();
