...
public class Worldwise extends AppCompatActivity {
    ...
    private WorldwiseAdapter countrywiseAdapter;
    private RequestQueue requestQueue;
    private ArrayList<WorldwiseModel> countrywiseModelArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worldwise);
    ...
    private void filter(String text) {
        ArrayList<WorldwiseModel> filteredList = new ArrayList<>();
        for (WorldwiseModel item : countrywiseModelArrayList) {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        countrywiseModelArrayList.add(new WorldwiseModel(countryName, countryConfirmed, countryActive, countryDeceased, countryNewConfirmed, countryNewDeceased, countryRecovered, countryTests, flagUrl));
                        ...
                        Collections.sort(countrywiseModelArrayList, new Comparator<WorldwiseModel>() {
                            @Override
                            public int compare(WorldwiseModel o1, WorldwiseModel o2) {
                    ...
                    if (!testValue.isEmpty()) {
                        Runnable progressRunnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                countrywiseAdapter = new WorldwiseAdapter(Worldwise.this, countrywiseModelArrayList);
    ...
    public void onItemClick(int position) {
        ...
        WorldwiseModel clickedItem = countrywiseModelArrayList.get(position);
    ...
    public void showProgressDialog() {
        progressDialog = new ProgressDialog(Worldwise.this);
        progressDialog.show();
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(Worldwise.this, "Internet slow/not available", Toast.LENGTH_SHORT).show();
                }
            }
        };
        Handler pdCanceller = new Handler();
