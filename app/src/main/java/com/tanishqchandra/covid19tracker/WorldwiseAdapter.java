...
public class WorldwiseAdapter extends  RecyclerView.Adapter<WorldwiseAdapter.ViewHolder> {
    private Context mContext;
    private ArrayList<WorldwiseModel> arrayList;
    private WorldwiseAdapter.OnItemClickListner mListner;
    ...
    public WorldwiseAdapter(Context context, ArrayList<WorldwiseModel> countrywiseModelArrayList) {
        mContext = context;
    ...
    @NonNull
    @Override
    public WorldwiseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.worldwise_row, parent, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull WorldwiseAdapter.ViewHolder holder, final int position) {
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WorldwiseModel clickedItem = arrayList.get(position);
        ...
        WorldwiseModel currentItem = arrayList.get(position);
    ...
    public void filterList(ArrayList<WorldwiseModel> filteredList) {
